 ...
 */
public class ElasticExclaimationBolt extends BaseElasticBolt {
    private static final long serialVersionUID = 1711761917521075103L;
    private OutputCollector collector;
    private long startTime;
    private boolean emit;
    private AtomicInteger nItems;

    public ElasticExclaimationBolt(boolean emit) {
        this.emit = emit;
    }
